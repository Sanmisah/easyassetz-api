...
class CommercialPropertyResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'agreementCopy' => $this->agreement_copy,
            'rentAgreementFile' => $this->rent_agreement_file,
            'shareCertificateFile' => $this->share_certificate_file,
            'leaseDocumentFile' => $this->lease_document_file,
            'name' => $this->name,
            'mobile' => $this->mobile,
            'email' => $this->email,
