...
class OtherLoanController extends BaseController
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $otherLoan->emi_date = $iso8601Date;
        $formatedDate2 = $request->input('startDate');
        $carbonDate2 = Carbon::parse($formatedDate2);
        $iso8601Date2 = $carbonDate2->toIso8601String();
        $otherLoan->start_date = $iso8601Date2;
